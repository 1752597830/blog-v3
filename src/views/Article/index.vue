...
import { ARTICLE_VISIT_PREFIX } from "@/const/Visits/index";
    ...
    <Main is-side-bar>
      ...
      <template #content>
        ...
        <div class="p-1">
          <div
            class="head_title"
            :style="`background-image: url('${articleDetail.cover}')`"
          >
          ...
          <div>
            ...
            <div>
              <MdPreview
                :editorId="id"
                :theme="mode"
                :modelValue="articleDetail.content"
            ...
            <div class="copyright">
              <div class="author">
                ...
                <strong
                  >本文作者： {{ websiteStore.webInfo?.webmasterName }}</strong
                >
              </div>
              <div class="link">
          ...
          <div style="display: flex; justify-content: space-between">
            <div class="tag">
              <template v-for="tag in articleDetail.tagNameList">
                <div>{{ tag }}</div>
              </template>
            </div>
            <div class="like">
              ...
              <template #content>
                <div class="qrCode">
                  <div>
                    支付宝
                    <el-image
                      src="http://60.204.242.251:9000/blog/pay.jpg"
                    />
                  </div>
                </div>
              </template>
        ...
        <div class="copyright">
          ...
          <div class="link">
            ...
            <a
              ...
              >{{ env.VITE_FRONTEND_URL + $route.path }}</a
            >
          </div>
          <div class="license">
            <div>
